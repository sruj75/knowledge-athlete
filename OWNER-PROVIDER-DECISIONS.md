...
- Created and verified 2026-08-29: public-ingress Cloud Run service `knowledge-athlete-dev` in `knowledge-athlete/us-west1`.
  ...
  - Active revision as of 2026-09-04: `knowledge-athlete-dev-e81de9b-33864696929-1`, serving 100% of development traffic from owned immutable OCI image digest `sha256:0986c910814999691903370ed75b43d8403bb92d476668a9799e6fa1236897c2` (runtime linux/amd64 manifest `sha256:2107d34b3053d554cf2254477e8dafb2275d1c572ad15a54d88d7b0ae7476b74`), built from exact `main` commit `e81de9b8e1d164ee9360e8df3ade93e636f1ed8d`.
...
- Provisioned 2026-09-02: the development deployment foundation for the existing `knowledge-athlete-dev` service.
  ...
  - Verified 2026-09-04: automatic development deployment run `33864696929` attempt 1 exchanged GitHub OIDC for the restricted deploy identity, built and verified the immutable image from exact `main` commit `e81de9b8e1d164ee9360e8df3ade93e636f1ed8d`, created a zero-traffic candidate, minted and deleted its short-lived Firebase probe user, passed public health, authenticated two-turn Gemini Chat, Firestore read, managed Gemini realtime, exact composition, and serving-vector checks, then promoted the candidate to 100% traffic. Rollback was not needed. Independent live probes completed Google-to-Firebase sign-in, authenticated OpenAI TTS, Modulate batch transcription, and Modulate live streaming through the promoted revision.
...
- [x] Prove the active revision's authenticated OpenAI TTS route and real Modulate batch/streaming continuity. All three live checks passed against revision `knowledge-athlete-dev-e81de9b-33864696929-1`.
