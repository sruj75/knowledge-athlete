...
- Created and verified 2026-08-29: public-ingress Cloud Run service `knowledge-athlete-dev` in `knowledge-athlete/us-west1`.
  ...
  - Active revision as of 2026-09-04: `knowledge-athlete-dev-9630523-33856867554-3`, serving 100% of development traffic from owned immutable OCI image digest `sha256:5ea6a9f096bd26756499e50c87a6dd6ded71ebdfc0a9b19c1d89d61c4657e882` (runtime linux/amd64 manifest `sha256:ed38387c912e376036b915befb2cdc076b8406465055d417888e4b5de35632c2`), built from exact `main` commit `9630523d2e9c8763bebdcf52ce4b3ff08475a607`.
...
- Provisioned 2026-09-02: the development deployment foundation for the existing `knowledge-athlete-dev` service.
  ...
  - Verified 2026-09-04: automatic development deployment run `33856867554` attempt 3 exchanged GitHub OIDC for the restricted deploy identity, built and verified the immutable image from exact `main`, created a zero-traffic candidate, minted and deleted its short-lived Firebase probe user, passed public health, authenticated two-turn Gemini Chat, Firestore read, managed Gemini realtime, exact composition, and serving-vector checks, then promoted the candidate to 100% traffic. Rollback was not needed. Independent read-back returned health `200` and protected Chat without Firebase auth `401`.
