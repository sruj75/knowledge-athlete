...
The active product is a macOS memory assistant with a bundled Node agent runtime
and managed Python backend. This repository derives from Omi; licenses and the
