...
class TestSubscriptionInvalidationConsumption:
    """Static tripwires for the retained listen-side invalidation consumer.

    Dodo projection invalidation is covered behaviorally in
    ``test_dodo_webhook_behavioral.py``.
    """
