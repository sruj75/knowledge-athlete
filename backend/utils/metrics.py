...
OMI_TRANSCRIPTION_ACCEPTED_TOTAL = Counter(
    'intentive_voice_transcription_accepted_total',
...
OMI_TRANSCRIPTION_COMPLETED_TOTAL = Counter(
    'intentive_voice_transcription_completed_total',
...
OMI_TRANSCRIPTION_LATENCY_SECONDS = Histogram(
    'intentive_voice_transcription_latency_seconds',
...
OMI_LIVE_STT_TERMINAL_FAILURES_TOTAL = Counter(
    'intentive_live_stt_terminal_failures_total',
...
OMI_LIVE_STT_ACCEPTED_TOTAL = Counter(
    'intentive_live_stt_accepted_total',
...
OMI_LIVE_STT_MISALIGNED_FRAMES_TOTAL = Counter(
    'intentive_live_stt_misaligned_frames_total',
