...
- **Resolved repository gate:** S-02 originally encountered an inherited
  `FC-agent-vm-stop-retains-disk` definition whose canonical artifact had been
  deleted by S-01. Wave 1 closeout deletes that Agent-VM-exclusive definition;
  it does not recreate the retired test or weaken generic failure-class
  validation. Failure-class guidance for the S-02 fix remains
  `Failure-Class: none`.
