...
#if DEBUG
  // omi-release-compile: this suite drives DesktopDiagnosticsManager's DEBUG-only
  // resetForTests seam; the release-mode notification regression step must
  // compile the bundle without it.
