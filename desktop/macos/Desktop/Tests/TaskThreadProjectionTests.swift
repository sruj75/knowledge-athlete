...
#if DEBUG
  // omi-release-compile: depends on DEBUG-only seams or fixtures from DEBUG-guarded
  // suites; the release-mode notification regression step compiles the bundle without them.
