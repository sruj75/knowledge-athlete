...
Stable promotions can span many beta builds. Build the curated stable release log from these per-build entries before the explicit Stable promotion described in the [release guide](../../../../openwiki/codebase/operations/releases.md).
